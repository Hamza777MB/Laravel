...
void DrawGLScene(GLvoid)									// Here's Where We Do All The Drawing
{
	...
	gluLookAt(12, 12, 30, 0, 0, 0, 0, 1, 0);
	//drawcube(0, 0, 0,1,1,0.2);
	...
	glTranslated(0, 0, 10);
	glRotated(angle, 0, 1, 0);
	//drawcube(0, 0, 0,0,1,0.5);
	glColor3f(0.0f, 1.0f, 0.5f);
	drawSphere(1, 30, 25);
	glRotated(angle, 0, 1, 0);
	glTranslated(0, 0, 3);
	//glScaled(0.5, 0.5, 0.5);
	//drawcube(0, 0, 0, 0.5, 0.5, 0.5);
	glColor3f(0.5f, 0.5f, 0.5f);
	drawSphere(0.5, 30, 25);
	glPopMatrix();
	float angle2 = 0.3*angle;
	//glScaled(0.7, 0.7, 0.7);
	glRotated(angle2, 0, 1, 0);
	glTranslated(0, 0, 20);
	//drawcube(0, 0, 0, 0.3, 0.5, 0.7);
	glColor3f(0.3f, 0.5f, 0.7f);
	drawSphere(1.5, 30, 25);
	...
	int			nCmdShow)			// Window Show State
{
	...
	UINT timer = SetTimer(hWnd, 0, 15, (TIMERPROC)NULL);
